...
## Bảo mật
- Tuyệt đối không commit thông tin nhạy cảm (API keys, keystore password, `.env` thật) vào Git.

## Liên hệ
- Người duy trì: (thêm thông tin liên hệ hoặc email tại đây)

## Giấy phép
- (Thêm thông tin license nếu cần, ví dụ MIT)

---

Nếu bạn muốn, tôi có thể:
- Chuẩn hoá README bằng tiếng Anh thay thế hoặc bổ sung.
- Thêm hướng dẫn chi tiết về CI/CD, phát hành trên Google Play hoặc cấu hình Firebase.
